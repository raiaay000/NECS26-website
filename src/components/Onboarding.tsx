...
const slides = [
  ...
  },
  {
    ...
    description: "Follow your favorite teams, view detailed player stats, and track tournament standings in real-time.",
  ...
  },
  {
    ...
    description: "Shop team jerseys, limited edition hoodies, posters, and exclusive NECS 2026 gear. Support your favorite teams in style!",
