...
const games = [
  { id: 1, name: "Valorant", description: "5v5 character-based tactical shooter", image: "https://images.unsplash.com/photo-1542751371-adc38448a05e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080", teams: 4, format: "Best of 3", prizePool: "$400,000" },
  { id: 2, name: "Rocket League", description: "High-powered hybrid of arcade soccer and driving", image: "https://images.unsplash.com/photo-1511512578047-dfb367046420?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080", teams: 4, format: "Best of 5", prizePool: "$350,000" },
  { id: 3, name: "Super Smash Bros", description: "Crossover fighting game featuring Nintendo characters", image: "https://images.unsplash.com/photo-1511882150382-421056c89033?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080", teams: 4, format: "Best of 5", prizePool: "$250,000" }
];

const infoCards = [
  { icon: Trophy, title: "$1M Total Prize Pool", desc: "Split across three epic competitions", color: "from-[#2f6bff] to-[#1a4ed6]", iconColor: "text-yellow-400" },
...
const formatSections = [
  ...
  { title: "Playoffs", color: "text-[#2f6bff]", bulletColor: "text-[#fbbf24]", items: ["May 8: Quarter Finals - Single elimination", "May 9: Semi Finals - Best of 5", "May 10: Grand Finals - Best of 7"] }
];
            ...
            <div key={game.id} className="bg-[#0a0a0a] border border-[#1a1a1a] rounded-lg overflow-hidden hover:border-[#2f6bff] transition-all group">
              ...
              <div className="p-6">
                ...
                <div className="space-y-2 mb-4">
                  {[["Teams", game.teams, "text-[#2f6bff]"], ["Format", game.format, ""], ["Prize Pool", game.prizePool, "text-[#fbbf24]"]].map(([label, value, color]) => (
                ...
                <button onClick={() => onGameSelect?.(game.name)} className="w-full bg-[#2f6bff] hover:bg-[#1a4ed6] text-white font-bold py-3 rounded-lg transition-colors flex items-center justify-center gap-2">
