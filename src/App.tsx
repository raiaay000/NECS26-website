...
useEffect(() => {
  // Always show onboarding on every page load
  ...
  const renderPage = () => {
    if (checkout) {
      return <Checkout cart={cart} onBack={() => setCheckout(false)} onClearCart={clearCart} />;
    }
    ...
    switch (page) {
      ...
      case "games":
        return <Games onGameSelect={(game) => nav(gameMap[game])} />;
      case "teams":
        return <Teams />;
      case "schedule":
        return <Schedule />;
      case "brackets":
        return <Brackets />;
      case "tickets":
        return <Tickets onAddToCart={addToCart} />;
      case "merch":
        return <Merch onAddToCart={addToCart} />;
      case "venue":
        return <Venue />;
      case "food":
        return <FoodMenu />;
      ...
      case "help":
        return <Help />;
      case "valorant":
        return <ValorantPage onBack={() => nav("games")} />;
      case "rocketleague":
        return <RocketLeaguePage onBack={() => nav("games")} />;
      case "supersmashbros":
        return <SuperSmashBrosPage onBack={() => nav("games")} />;
      case "profile":
        return <Profile userName={userName} isGuest={isGuest} />;
      case "reminders":
        return <Reminders isGuest={isGuest} />;
      case "settings":
        return <Settings isGuest={isGuest} />;
      default:
        return <Home onNavigate={nav} />;
    }
  };
